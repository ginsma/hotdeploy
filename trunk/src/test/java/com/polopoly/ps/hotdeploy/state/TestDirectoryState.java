...
public class TestDirectoryState extends TestCase {
	...
	public void testChangeBothChecksumsAfterReset()
	...
	public void testChangeQuickChecksumsAfterReset()
			throws CouldNotUpdateStateException {
		directoryState.reset(file, false);
	...
	public void testChangeSlowChecksumsAfterReset()
			throws CouldNotUpdateStateException {
		directoryState.reset(file, false);
	...
	@Override
	public void setUp() {
		directoryState = new DefaultDirectoryState(
				new NonPersistedFileChecksums());
