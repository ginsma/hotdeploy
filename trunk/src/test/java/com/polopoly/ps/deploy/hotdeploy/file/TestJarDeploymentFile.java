...
public class TestJarDeploymentFile extends TestCase {
	...
	public void testReadFailure() throws IOException {
		try {
			new JarDeploymentFile(jarFile, jarFile.getEntry("fail.xml"))
					.getInputStream();
	...
	public void testEquality() {
		JarDeploymentFile fileb = new JarDeploymentFile(jarFile,
				jarFile.getEntry("a.xml"));
	...
	public void testGetBaseURL() throws MalformedURLException {
		...
		System.out.println(file2 + " " + file2.getBaseUrl());
		assertEquals("jar:file:" + jarAbsoluteName + "!/", file.getBaseUrl()
				.toString());
		assertEquals("jar:file:" + jarAbsoluteName + "!/b/", file2.getBaseUrl()
				.toString());
	}
