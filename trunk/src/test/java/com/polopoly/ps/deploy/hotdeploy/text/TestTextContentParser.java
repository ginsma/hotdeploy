package com.polopoly.ps.deploy.hotdeploy.text;
...
import com.polopoly.ps.deploy.text.ExternalIdReference;
import com.polopoly.ps.deploy.text.Reference;
import com.polopoly.ps.deploy.text.StandAloneValidationContext;
import com.polopoly.ps.deploy.text.TextContent;
import com.polopoly.ps.deploy.text.TextContentParser;
import com.polopoly.ps.deploy.text.TextContentSet;
import com.polopoly.ps.deploy.text.ValidationException;
...
public class TestTextContentParser extends TestCase {
    ...
    public void testSimpleContent() throws Exception {
        ...
        assertEqualsReference("p.siteengine.Sites.d", article
                .getSecurityParent());
        assertEqualsReference("com.polopoly.ps.DefaultPageLayout", article
