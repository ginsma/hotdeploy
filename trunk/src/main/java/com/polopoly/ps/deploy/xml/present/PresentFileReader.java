...
import com.polopoly.ps.deploy.hotdeploy.discovery.FallbackDiscoverer;
...
import com.polopoly.ps.deploy.hotdeploy.file.ResourceFile;
	...
	protected void scanContent() {
		try {
			...
			logger.log(Level.INFO,
					"The directory " + rootDirectory.getAbsolutePath()
	...
	private void readListOfExternalIds(DeploymentObject file, Major major) {
		try {
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(
					presentContent.getInputStream(), "UTF-8"));
