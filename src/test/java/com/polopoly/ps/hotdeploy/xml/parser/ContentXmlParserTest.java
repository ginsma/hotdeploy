...
/**
 * Note that parsing content XML to TextContent is not fully implemented, for example it doesn't support content lists.
 */
public class ContentXmlParserTest extends TestCase {
	...
	public void testComponents() {
		...
		Assert.assertEquals("Category", content.getComponent("categorization[department.categorydimension.tag.Tag]", "text"));
	}
	...
	public void testFile() throws Exception {
		Assert.assertEquals("file content", new String(content.getFile("image/file.txt"), "UTF-8"));
	}
