...
public class TestTextContentParser extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        TextContentParser parser = new TextContentParser(is, getClass().getResource(resourceName), resourceName);
    ...
    public void testSimpleContent() throws Exception {
        ...
        assertEquals("Test Page: name", article.getComponent(CONTENT_ATTRG_SYSTEM, CONTENT_ATTR_NAME));
        ...
        assertEqualsReference("com.polopoly.ps.DefaultPageLayout", article.getReference("pageLayout", "selected"));
